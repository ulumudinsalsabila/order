<!doctype html>
	...
	<head>
		<meta charset="UTF-8">
		<title>HISTORY TRANSAKSIH</title>
		...
		<div class="container">
			<div class="box-body">
				<div class="table-responsive22">
					...
					<form action="dhistory.php" method="post">
						<div class="box-toole pull-right" style="margin-right: 2px;">
							<a href="laporan.php?jenis=History Transaksi&tipe=<?php echo $tipe ?>" class="btn btn-info btn-flat " target="_blank" ><i class="fa fa-file-pdf-o"></i>Cetak Laporan</a>
						</div>
						<div class="box-toole pull-right" style="margin-right: 2px;">
					...
					<table id="datatable" class="table table-bordered table-striped">
						...
						<tbody>
							...
							if ($bulan) {
								$where .= " AND MONTH(STR_TO_DATE(waktu,'%Y-%m-%d')) = '{$bulan}' " ;
							}

							$ambildata = mysqli_query($conn,"SELECT * FROM transaksi where status = '2' ".$where);
