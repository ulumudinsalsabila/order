				...
				<div class="table-responsive22">
					...
					<form action="user.php" method="post">
						<div class="box-toole pull-right" style="margin-right: 2px;">
							...
							<a href="register.php" class="btn btn-info">Tambah</a>
						</div>
						<div class="box-toole pull-right" style="margin-right: 2px;">
					...
					<table id="datatable" class="table table-bordered table-striped">
						...
						<tbody>
							...
							$ambildata = mysqli_query($conn,"SELECT * FROM users where 1 = 1 ".$where);
							...
							if ($row > 0) {
								while($tampil = mysqli_fetch_array($ambildata)){
									...
									<tr>
										...
										<td><center>".$tampil['username']."</center></td>
										<td><center>".$tampil['email']."</center></td>
										<td>
											<center> 
												<a href=\"deleteuser.php?id=". $tampil['id']."\" class=\"btn btn-danger btn-flat btn-xs\" data-toggle=\"modal\" data-target=\"#delete<?php echo $no; ?>\"><i class=\"fa fa-trash\"></i> Delete</a>
												<a href=\"edituser.php?id=". $tampil['id']."\" class=\"btn btn-primary btn-flat btn-xs\"  ><i class=\"fa fa-pencil\"></i>Edit</a>
											</center>
										</td>
									</tr>";
									$no++;
