<!doctype html>
	...
	<head>
		<meta charset="UTF-8">
		<title>TRANSAKSI LONG MONTH</title>
			...
			<div class="box-body">
				<div class="table-responsive22">
					...
					<table id="datatable" class="table table-bordered table-striped">
						<thead>
							<tr>
								<H2>DATA TRANSAKSI BULAN INI</H2>
						...
						<tbody>
							...
							$ambildata = mysqli_query($conn,"SELECT * FROM transaksi where MONTH(waktu) = MONTH(NOW()) AND YEAR(waktu)= YEAR(NOW()) ".$where);
